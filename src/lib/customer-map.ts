...
const CITY_COORDS: Record<string, Coordinate> = {
  ...
  "FLORIANOPOLIS/SC": { lat: -27.59, lng: -48.55 },
  "JOINVILLE/SC": { lat: -26.3, lng: -48.84 },
  "BLUMENAU/SC": { lat: -26.91, lng: -49.06 },
  "ITAJAI/SC": { lat: -26.91, lng: -48.66 },
  "CRICIUMA/SC": { lat: -28.67, lng: -49.37 },
  "CHAPECO/SC": { lat: -27.1, lng: -52.61 },
  "LAGES/SC": { lat: -27.81, lng: -50.32 },
  "BALNEARIO CAMBORIU/SC": { lat: -26.99, lng: -48.63 },
  "TUBARAO/SC": { lat: -28.48, lng: -48.77 },
  "CURITIBA/PR": { lat: -25.43, lng: -49.27 },
  "LONDRINA/PR": { lat: -23.31, lng: -51.16 },
  "MARINGA/PR": { lat: -23.42, lng: -51.93 },
  "PONTA GROSSA/PR": { lat: -25.09, lng: -50.16 },
  "CASCAVEL/PR": { lat: -24.95, lng: -53.46 },
  "FOZ DO IGUACU/PR": { lat: -25.54, lng: -54.58 },
  ...
  "UBATUBA/SP": { lat: -23.43, lng: -45.07 },
  "PRAIA GRANDE/SP": { lat: -24.01, lng: -46.41 },
  "GUARUJA/SP": { lat: -23.99, lng: -46.25 },
  "ITANHAEM/SP": { lat: -24.18, lng: -46.79 },
  "MONGAGUA/SP": { lat: -24.09, lng: -46.62 },
  "PERUIBE/SP": { lat: -24.32, lng: -46.99 },
  "SALVADOR/BA": { lat: -12.97, lng: -38.5 },
  "PORTO SEGURO/BA": { lat: -16.44, lng: -39.06 },
  "ILHEUS/BA": { lat: -14.79, lng: -39.03 },
  "RECIFE/PE": { lat: -8.05, lng: -34.9 },
  "OLINDA/PE": { lat: -8.01, lng: -34.85 },
  "ARACAJU/SE": { lat: -10.91, lng: -37.07 },
  "MACEIO/AL": { lat: -9.66, lng: -35.73 },
  "JOAO PESSOA/PB": { lat: -7.12, lng: -34.86 },
  "NATAL/RN": { lat: -5.79, lng: -35.21 },
  "FORTALEZA/CE": { lat: -3.73, lng: -38.52 },
  "SAO LUIS/MA": { lat: -2.53, lng: -44.3 },
  "PORTO ALEGRE/RS": { lat: -30.03, lng: -51.23 },
  "PELOTAS/RS": { lat: -31.76, lng: -52.34 },
  "RIO GRANDE/RS": { lat: -32.03, lng: -52.1 },
};
