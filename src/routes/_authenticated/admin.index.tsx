...
const areas = [
  ...
  { to: "/admin/marcas", icon: Bookmark, title: "Marcas", text: "Gerencie a visibilidade das marcas no catálogo." },
  { to: "/admin/categorias", icon: ListChecks, title: "Gestão de Categorias", text: "Revise e ajuste manualmente as categorias sugeridas pelo importador ERP." },
